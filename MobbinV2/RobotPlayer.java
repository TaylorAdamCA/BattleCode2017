...
//						//System.out.println("Built a gardener. rc.readBroadcast(readyToSpawn) = " + rc.readBroadcast(readyToSpawn)+"rc.readBroadcast(gardYes) "+ rc.readBroadcast(gardYes));
//					}
//				}
			...
			try {
				...
				if ((!rc.isCircleOccupiedExceptByThisRobot(rc.getLocation(), RobotType.GARDENER.bodyRadius * 2)
					...
					if(scoutSoldierTree==0){
						...
						if(tryToBuild(RobotType.SOLDIER, RobotType.SCOUT.bulletCost)){
